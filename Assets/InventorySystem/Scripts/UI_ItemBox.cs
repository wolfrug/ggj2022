...
namespace Inventory {
    public class UI_ItemBox : MonoBehaviour {
        ...
        public bool m_initOnStart = false;
        ...
        public void SetDraggable (bool canDrag) {
            ...
            if (animator != null && gameObject.activeInHierarchy) {
                if (highlight) {
                    ...
                    animator.SetBool ("Draggable", true);
                }
            }
        }
        ...
        public int StackLeft {
            get {
                if (data.HasTrait (ItemTrait.STACKABLE)) {
                    return data.m_maxStackSize - m_stackAmount;
                } else {
                    return 0; // never any stack left if you can't stack it D:
                }
            }
        }
